...
?>
  ...
  <div class="containercadastro">
    <?php
        if(isset($_GET['errodeexclusao'])) {
          echo '<p style="text-align:center;color:green">Não foi possível realizar a exclusão do seu item. </p>';
        }
      ?>
        <div class="cadastro">
          <fieldset>
            <legend>Exclui item:</legend>
            <form action="excluiItem.php" method="post" name="formulario">
              ...
              <table class="tableeditar">
                <tbody>
                  ...
                  <tr>
                    <td></td>
                    <td><input class="botao" type="submit" value="Excluir" /></td>
                  </tr>
