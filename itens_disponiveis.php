...
?>
  ...
  <main>
      <div class="containeritens">
        <div class="cadastro">
          <?php
            if(isset($_GET['errodeemprestimo'])) {
              echo '<p style="text-align:center;color:black">Não foi possível emprestar o objeto. </p>';
            }
            if(isset($_GET['errodeemprestimo'])) {
              echo '<p style="text-align:center;color:red">Esse objeto já foi emprestado. </p>';
            }
            
          ?>
          
            <h3>Lista de Itens para empréstimo</h3>
              ...
              <th class="table-dark" colspan="1">Ação</th>
                  ...
                  <?php
                    ...
                    $sql = "SELECT id, objeto, estado_obj, disponibilidade FROM cadastra_itens WHERE iddono not like '$idproprio'";
                    ...
                    while($row = mysqli_fetch_assoc($res)) {
                      ...
                      <td><a href='pegarEmprestado.php?id=". $row['id'] ."'>Emprestar</td>
                      </tr>";
                    }
                  ?>
